...
switch($request[0]) {
    ...
    case 'archive':
        // full strip listing
        $comics = $db->fetch("SELECT c.*, ch.title AS chapter_title, ch.slug AS chapter_slug FROM comics c LEFT JOIN chapters ch ON c.chapterid = ch.chapterid ORDER BY c.pub_date ASC");
